...
const SearchLive = async (keyword, cookie, page = 1) => new Promise(async (resolve) => {
    (0, axios_1.default)((0, api_1._tiktokSearchLiveFull)((0, params_1._liveSearchParams)(keyword, page)), {
        ...
        if (data.status_code !== 0)
            return resolve({ status: "error", message: "Failed to find live. Make sure the keywords you are looking for are correct..." });
        const result = [];
        if (!data.data)
